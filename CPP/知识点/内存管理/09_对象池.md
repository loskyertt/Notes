...
> [!tip]
> 0x1008 % 32 可以写成 0x1008 % $2^5$（幂为 5），因此只需要把 0x1008 展开成 2 进制（0001 0000 0000 1000），看后 5 位即可：后 5 位为 0 1000，故不按 32 字节对齐。
...
0x1000          0x1008          0x1020          0x1060          0x10A0          0x10E0
  ...
  v               v               v               v               v               v
+---------------+---------------+---------------+---------------+---------------+---------------+
| Block Header  | padding       | Slot0         | Slot1         | Slot2         | Slot3         |
+---------------+---------------+---------------+---------------+---------------+---------------+
                                ^
                                base
```
